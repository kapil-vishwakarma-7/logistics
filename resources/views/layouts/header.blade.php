...
<!-- side nav css file -->
<link href="{{ url('front/css/SidebarNav.min.css') }}" media='all' rel='stylesheet' type='text/css'/>
<!-- //side nav css file -->
...
<!-- chart -->
<script src="{{url('front/js/Chart.js') }}"></script>
<!-- //chart -->
...
<script src=" {{ url('front/js/pie-chart.js') }} " type="text/javascript"></script>
            ...
            <ul class="sidebar-menu">
			  ...
			  <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="grids.html"><i class="fa fa-angle-right"></i> Add Shipment</a></li>
                  <li><a href="media.html"><i class="fa fa-angle-right"></i> View Shipment</a></li>
                </ul>
              </li>
			  ...
			  <li>
                <a href="widgets.html">
                <i class="fa fa-th"></i> <span>Shipping Rates</span>
              ...
              <li>
                <a href="widgets.html">
                <i class="fa fa-th"></i> <span>Complaint</span>
                <small class="label pull-right label-info">08</small>
                </a>
              </li>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="tables.html"><i class="fa fa-angle-right"></i>Personal Setting</a></li>
                  <li><a href="tables.html"><i class="fa fa-angle-right"></i>Company</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
